...
def print_summary(result: ScanResult) -> None:
    ...
    console.print(Panel(
        ...
        title="[bold]SecForge Scan Complete[/bold]",
...
def to_markdown(result: ScanResult, path: Optional[str] = None) -> str:
    ...
    lines += [
        ...
        f"| **Scanner** | SecForge v{result.scanner_version} |",
        f"",
        f"## Summary",
        f"",
        f"| Severity | Count |",
    ...
    lines += [
        f"---",
        f"",
        f"*Generated by [SecForge](https://github.com/apiscan-ai/secforge) — "

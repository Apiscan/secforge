...
<title>SecForge Report — {result.target.url}</title>
<style>
...
<div class="container">
  <header>
    ...
    <div class="meta">
      ...
      <strong>Scanner:</strong> SecForge v{result.scanner_version}
    </div>
  </header>
  ...
  <footer>
    Generated by <strong>SecForge v{result.scanner_version}</strong> &mdash;

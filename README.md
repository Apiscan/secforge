...
ApiScan enforces this via the `scope_acknowledged: true` flag in your target profile and the `--yes` CLI flag. Unauthorized scanning is illegal under computer crime laws in most jurisdictions.
